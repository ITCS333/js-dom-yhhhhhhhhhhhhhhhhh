...
function changeHeadingText() {
  // TODO: const heading = document.getElementById('main-heading'); heading.textContent = 'DOM Manipulation Challenge';
...
function changeBoxColor() {
  // TODO: const box = document.getElementById('box-to-modify'); box.style.backgroundColor = 'lightblue';
 ...
 */
function addNewItem() {
  // TODO: const newLi = document.createElement('li'); newLi.textContent = 'New Item'; const list = document.getElementById('item-list'); list.appendChild(newLi);
...
function highlightParagraph() {
  // TODO: const para = document.querySelector('.content-para'); para.classList.add('highlight');
...
function removeElement() {
  // TODO: const element = document.getElementById('to-be-removed'); if (element) { element.remove(); }
